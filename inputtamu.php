...
echo"<form action=\"inputtamu.php\" method=\"post\" enctype=\"multipart/form-data\">";	
$id=$_POST['id'];	
$nama=$_POST['nama'];
$alamat=$_POST['alamat'];
$kota=$_POST['kota'];
...
<?php echo"<input name=\"nama\" $disabled type=\"text\" style=\"width: 100%\" value=\"$nama\">"; ?>
	...
	<tr><td width="10%">Kota</td>
		<td width="2%">:</td>
		<td width="88%">
<?php echo"<input name=\"kota\" $disabled type=\"text\" style=\"width: 100%\" value=\"$kota\">"; ?>
		</td>
	</tr>
	
	<tr><td width="10%">Provinsi</td>
		<td width="2%">:</td>
		<td width="88%">
<?php echo"<input name=\"provinsi\" $disabled type=\"text\" style=\"width: 100%\" value=\"$provinsi\">"; ?>
		</td>
	</tr>
